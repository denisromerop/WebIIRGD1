...
namespace WebCampeonato.Controllers
{
    public class JogosController : Controller
    {
        ...
        public JogosController(CampeonatoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Local,DataHora")] Jogo jogo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Local,DataHora")] Jogo jogo)
        {
            if (id != jogo.Id)
            {
                return NotFound();
